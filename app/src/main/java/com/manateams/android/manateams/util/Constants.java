...
public class Constants {
    ...
    public static final String[] COLORS = {"#e51c23", "#3f51b5", "#259b24", "#ff9800", "#607d8b", "#5677fc", "#8bc34a", "#009688", "#e91e63"};
    public static final String FILE_COURSES = "courses";
    public static final String FILE_BASE_CLASSGRADES = "classgrades";
    public static final long INTERVAL_GRADE_SCRAPE = 60000; // 60 seconds
}
